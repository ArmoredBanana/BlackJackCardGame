...
#print list out
numberOfPlayers = int(input("how many players do you want to play"))
...
def check_who_won_between_the_dealer_and_the_player(player_1_cards,dealer_cards):
    while player_1_cards < 22 and dealer_cards < 22:
        if dealer_cards < 17:
            random_card_3 = random.choice(list_of_cards)
            dealer_cards += random_card_3
        
        if player_1_cards < dealer_cards and dealer_cards <= 21:
            print("The dealer won!! your cards were", player_1_cards,"The dealers cards were", dealer_cards)
            player_won = 2
            return player_won
            break

        elif player_1_cards > dealer_cards:
            print("The player won!! your cards were", player_1_cards,"The dealers cards were", dealer_cards)
            player_won = 1
            return player_won
            break
        elif player_1_cards == dealer_cards:
    ...
    if player_1_cards > 21:
        print("dealer won because your cards went over 21", player_1_cards)
        
    elif dealer_cards <= 21 and player_1_cards <= 21:
        if dealer_cards == player_1_cards:
            print("The dealer won because you guys had the same ammount of cards")
            player_won = 2
        elif dealer_cards > player_1_cards:
        ...
        print("The player won because the dealer went over 21 and you didn't. WHAT A LUCKY PLAYER")
        player_won = 1
...
def add_money():
    if player_won == 1:
        player_1_money += betted_money_for_p1 + betted_money_for_p1*.5
        print("Your money balance is: ", player_1_money)
    if player_won == 2:
        player_1_money -= betted_money_for_p1
        print("You money balance now is: ", player_1_money)
